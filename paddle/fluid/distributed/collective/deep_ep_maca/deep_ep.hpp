...
#include <tuple>
#include <vector>
#include "paddle/fluid/distributed/collective/deep_ep_maca/include/types.h"

#include "paddle/fluid/distributed/collective/deep_ep_maca/config.hpp"
#include "paddle/fluid/distributed/collective/deep_ep_maca/event.hpp"
...
struct Buffer {
 ...
 private:
  ...
  phi::distributed::XCCLCommContext* comm_ctx;
  phi::CustomContext* calc_ctx;
