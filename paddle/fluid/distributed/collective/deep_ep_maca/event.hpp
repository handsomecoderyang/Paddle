...
#include "paddle/fluid/distributed/collective/deep_ep_maca/include/CUDAStream.h"
#include "paddle/fluid/distributed/collective/deep_ep_maca/include/event.h"
...
EventHandle GetEventHandleFromCustomStream(const cudaStream_t& stream);
